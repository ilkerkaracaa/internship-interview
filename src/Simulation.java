        ...
        for (int i = 0; i < 1000; i++) {
            ...
            while (iterator.hasNext()) {
                ...
                if(avci.Ad.equals("Kurt")) {
                    ...
                    for (Canli av : canlilar) {
                        if(av instanceof Koyun || av instanceof Inek || av instanceof Tavuk || av instanceof Horoz || av instanceof Kurt || av instanceof Aslan) {
                            if(Math.sqrt(Math.pow(avci.X - av.X, 2) + Math.pow(avci.Y - av.Y, 2)) <= 5) {
                                System.out.println(avci.Ad + " " + av.Ad + " avladı");
                                iterator.remove();
                                break;
